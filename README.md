...
<div align="center">
  <p>
    ...
    <p>웰컴 토스트는 JavaScript 연동 스크립트, 관리자 페이지를 제공합니다.</p>
  </p>
  GitHub
  <a href="https://github.com/welcome-toast/welcome-toast">연동 스크립트</a> | <a href="https://github.com/welcome-toast/admin">관리자 페이지</a>
</div>
...
- [개발 과정](#%EA%B0%9C%EB%B0%9C-%EA%B3%BC%EC%A0%95)
  ...
  * [적용된 모습을 미리 보면서 토스트 메시지를 설정할 수 있도록 하자](#%EC%A0%81%EC%9A%A9%EB%90%9C-%EB%AA%A8%EC%8A%B5%EC%9D%84-%EB%AF%B8%EB%A6%AC-%EB%B3%B4%EB%A9%B4%EC%84%9C-%ED%86%A0%EC%8A%A4%ED%8A%B8-%EB%A9%94%EC%8B%9C%EC%A7%80%EB%A5%BC-%EC%84%A4%EC%A0%95%ED%95%A0-%EC%88%98-%EC%9E%88%EB%8F%84%EB%A1%9D-%ED%95%98%EC%9E%90)
    + [iFrame을 통한 웹사이트 로드가 최선일까?](#iframe%EC%9D%84-%ED%86%B5%ED%95%9C-%EC%9B%B9%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%A1%9C%EB%93%9C%EA%B0%80-%EC%B5%9C%EC%84%A0%EC%9D%BC%EA%B9%8C)
    + [보안과 CORS 이슈 해결하기](#%EB%B3%B4%EC%95%88%EA%B3%BC-cors-%EC%9D%B4%EC%8A%88-%ED%95%B4%EA%B2%B0%ED%95%98%EA%B8%B0)
    + [message 이벤트 핸들링](#message-%EC%9D%B4%EB%B2%A4%ED%8A%B8-%ED%95%B8%EB%93%A4%EB%A7%81)
...
처음에는 모든 설정을 코드로 관리하는 방식을 택했습니다. 유저 데이터(메시지 콘텐츠, 스타일 설정 데이터)들을 서비스에서 저장할 필요 혹은, 웹페이지에서 UI 표시 과정에서 매번 서버와 통신할 필요 없는 것이 장점이라 생각했습니다. 하지만 개발자 외에는 설정이 어려웠습니다. 개발자에게도 번거로움이 있었는데, 코드 적용결과를 따로 확인하고, 코드 레벨에서 학습이나 디버깅이 필요할 수 있기 때문입니다.
...
기존 서비스들의 구조, 소스 코드를 레퍼런스로 분석한 후 설계를 진행했습니다. 먼저 채널톡 소스 코드 분석을 통해 의사결정한 주요 사항은 아래와 같습니다.
